...
export const ChooseStartStationTests = () => {
  it('should choose start station\n(選擇出發站為臺北)', () => {
    ...
    cy.get('@county').contains('常用').should('be.visible');
    cy.get('@county').contains('基隆市').should('be.visible');
    cy.get('@county').contains('新北市').should('be.visible');
    cy.get('@county').contains('臺北市').should('be.visible').click();
    cy.get('@county').contains('桃園市').should('be.visible');
    cy.get('@county').contains('新竹縣').should('be.visible');
    cy.get('@county').contains('新竹市').should('be.visible');
    cy.get('@county').contains('苗栗縣').should('be.visible');
    cy.get('@county').contains('臺中市').should('be.visible');
    cy.get('@county').contains('彰化縣').should('be.visible');
    cy.get('@county').contains('南投縣').should('be.visible');
    cy.get('@county').contains('雲林縣').should('be.visible');
    cy.get('@county').contains('嘉義縣').should('be.visible');
    cy.get('@county').contains('嘉義市').should('be.visible');
    cy.get('@county').contains('臺南市').should('be.visible');
    cy.get('@county').contains('高雄市').should('be.visible');
    cy.get('@county').contains('屏東縣').should('be.visible');
    cy.get('@county').contains('臺東縣').should('be.visible');
    cy.get('@county').contains('花蓮縣').should('be.visible');
    cy.get('@county').contains('宜蘭縣').should('be.visible');
