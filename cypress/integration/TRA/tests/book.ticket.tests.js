...
export const ChooseGoCarTypeTest = () => {
  it('should choose start train type\n(選擇去程時段及車種)', () => {
    ...
    cy.get('#rideDate1.rideDate').type(20210728);
    cy.get('input[name="ticketOrderParamList[0].rideDate"]').should('have.value', '2021/07/28')
...
export const ChooseReturnCarTypeTest = () => {
  it('should choose return train type and ticket quantity\n(選擇回程時段及車種)', () => {
    ...
    cy.get('#rideDate2.rideDate').type(20210730);
    cy.get('input[name="ticketOrderParamList[1].rideDate"]').should('have.value', '2021/07/30')
